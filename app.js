...
const App = (() => {
  ...
  const DECOR = {
    ...
    // Each sparse season below had exactly 1 piece — season-check.js flags
    // any festival under 2 as feeling empty on arrival (§7.2) and literally
    // says "ask Claude to design some". One more per season, matching the
    // existing hand-drawn language (soft fill, darker outline, one highlight).
    choco_box:  { k:'a6', name:'巧克力礼盒', art:'🍫', slot:'floor', ratio:0.44, price:50,
                   from:'02-08', to:'02-20', season:'情人节',
                   svg:_ds(`<path d="M16 50h68v28a5 5 0 0 1-5 5H21a5 5 0 0 1-5-5z" fill="#8A5A34" stroke="#5C3A1F" stroke-width="2.8" stroke-linejoin="round"/> <rect x="22" y="54" width="56" height="20" rx="3" fill="#4A2E1B"/> <circle cx="33" cy="64" r="6" fill="#B5794A" stroke="#7A4E2C" stroke-width="1.8"/> <circle cx="50" cy="64" r="6" fill="#E896B4" stroke="#B4577C" stroke-width="1.8"/> <circle cx="67" cy="64" r="6" fill="#F0CE84" stroke="#B99231" stroke-width="1.8"/> <path d="M12 50h76l-5-11a5 5 0 0 0-5-3H22a5 5 0 0 0-5 3z" fill="#D6524B" stroke="#93302A" stroke-width="2.8" stroke-linejoin="round"/> <path d="M50 36c-6-8-16-6-16 1 0 5 8 6 16-1z" fill="#F2D68A" stroke="#B08D2C" stroke-width="2.2" stroke-linejoin="round"/> <path d="M50 36c6-8 16-6 16 1 0 5-8 6-16-1z" fill="#F2D68A" stroke="#B08D2C" stroke-width="2.2" stroke-linejoin="round"/> <circle cx="50" cy="37" r="4" fill="#E8A339" stroke="#B08D2C" stroke-width="1.6"/>${_hi(30,58,6,4)}`) },
    sachet_charm:{ k:'a7', name:'端午香囊', art:'🧵', slot:'wall', ratio:0.34, price:45,
                   from:'05-25', to:'06-25', season:'端午',
                   svg:_ds(`<circle cx="50" cy="16" r="5" fill="none" stroke="#8A6137" stroke-width="2.4"/> <path d="M50 21v5" stroke="#8A6137" stroke-width="2.2" stroke-linecap="round"/> <path d="M50 26L74 50L50 80L26 50Z" fill="#E24B4B" stroke="#A82B2B" stroke-width="2.8" stroke-linejoin="round"/> <path d="M50 36L64 50L50 68L36 50Z" fill="none" stroke="#F2D68A" stroke-width="2"/> <circle cx="50" cy="50" r="4" fill="#F2D68A" stroke="#B08D2C" stroke-width="1.4"/> <path d="M42 80l-4 13M50 80v15M58 80l4 13" stroke="#A82B2B" stroke-width="2.2" stroke-linecap="round"/> <circle cx="38" cy="94" r="2.2" fill="#F2D68A"/><circle cx="50" cy="96" r="2.2" fill="#F2D68A"/><circle cx="62" cy="94" r="2.2" fill="#F2D68A"/>${_hi(42,42,6,4)}`) },
    champagne_tower:{ k:'a8', name:'香槟塔', art:'🥂', slot:'floor', ratio:0.50, price:50,
                   from:'12-10', to:'01-05', season:'节日',
                   svg:_ds(`<ellipse cx="50" cy="86" rx="26" ry="6" fill="#C9B79A" stroke="#9C8B72" stroke-width="2.2"/> <path d="M20 64L40 64 33 82 27 82Z" fill="#EAF6FB" stroke="#9CC4D8" stroke-width="2" stroke-linejoin="round"/> <path d="M40 64L60 64 53 82 47 82Z" fill="#EAF6FB" stroke="#9CC4D8" stroke-width="2" stroke-linejoin="round"/> <path d="M60 64L80 64 73 82 67 82Z" fill="#EAF6FB" stroke="#9CC4D8" stroke-width="2" stroke-linejoin="round"/> <path d="M42 46L58 46 52 64 48 64Z" fill="#EAF6FB" stroke="#9CC4D8" stroke-width="2" stroke-linejoin="round"/> <path d="M23 74L37 74 33 82 27 82Z" fill="#F2D68A"/> <path d="M43 74L57 74 53 82 47 82Z" fill="#F2D68A"/> <path d="M63 74L77 74 73 82 67 82Z" fill="#F2D68A"/> <path d="M45 56L55 56 52 64 48 64Z" fill="#F2D68A"/> <circle cx="30" cy="70" r="1.6" fill="#fff" opacity="0.8"/><circle cx="70" cy="70" r="1.4" fill="#fff" opacity="0.7"/><circle cx="50" cy="52" r="1.3" fill="#fff" opacity="0.8"/>`) },
