...
const App = (() => {
  ...
  const ADAI_SVG = `<svg class="char-svg" id="char-svg-2" viewBox="0 0 110 132" xmlns="http://www.w3.org/2000/svg">
    ...
    <g id="adai-left-ear">
      <path d="M 28 45 Q 4 43 4 65 Q 4 86 18 93 Q 32 98 39 82 Q 46 64 36 43 Z" fill="#F8F0F4" stroke="#F0C0D4" stroke-width="1.5"/>
    </g>
    <g id="adai-right-ear">
      <path d="M 82 45 Q 106 43 106 65 Q 106 86 92 93 Q 78 98 71 82 Q 64 64 74 43 Z" fill="#F8F0F4" stroke="#F0C0D4" stroke-width="1.5"/>
    </g>
    <ellipse cx="55" cy="86" rx="37" ry="42" fill="white" stroke="#F0C0D4" stroke-width="1.5"/>
    <ellipse cx="55" cy="65" rx="27" ry="24" fill="#FAF8F8" stroke="#F0C0D4" stroke-width="1"/>
